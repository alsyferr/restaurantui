...
const LoginPage = () => {
  ...
  return (
    <div className='h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex p-4 items-center justify-center'>
      {/* BOX */}
      <div className='h-full shadow-2xl rounded-md flex flex-col md:flex-row md:h-[70%] md:w-full lg:w-[60%] lg:h-full 2xl:h-[70%] 2xl:w-1/2'>
         {/* IMAGE CONTAINER */}
